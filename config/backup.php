...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL', 'admin@iron-gym.local'),
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => 7, // 7 backup giornalieri
             ...
             */
            'keep_weekly_backups_for_weeks' => 4, // 4 backup settimanali

            /*
             * After the "keep_weekly_backups_for_weeks" period is over, the most recent backup
             * of that month will be kept. Older backups within the same month will be removed.
             */
            'keep_monthly_backups_for_months' => 3, // 3 backup mensili
