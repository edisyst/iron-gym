...
- [test-per-ruolo.md](review/test-per-ruolo.md) — matrice test Pest per ruolo (archiviata al 2026-08-23, suite ora a 506 test)
...
- [doc-audit/](review/doc-audit/) — DOC01 audit documentazione (2026-08-23): inventario, snapshot, findings, matrice permessi; DOC02 findings (2026-08-30)
