...
<div>
    <x-bo.filters>
        <div class="row">
            <div class="col-auto">
                <select wire:model.live="filterStatus" class="form-control form-control-sm filter-w-xs">
            ...
            <x-bo.card bodyClass="p-0">
                ...
                <table class="table table-sm table-striped table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <x-bo.empty :colspan="6">Nessun corso trovato.</x-bo.empty>
                        @endforelse
                    </tbody>
                </table>
                </div>
                ...
                <x-slot name="footer">
                    <x-bo.pagination :paginator="$classes" />
                </x-slot>
            </x-bo.card>
        </div>
