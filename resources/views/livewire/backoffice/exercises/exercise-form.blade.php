<div>
    ...
    <form wire:submit="save">
        ...
        <x-bo.card title="Informazioni base" bodyClass="p-3">
        ...
        {{-- Sezione: media --}}
        <x-bo.card title="Immagine e Video" bodyClass="p-3">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <x-bo.card title="Pattern motorio" bodyClass="p-3">
            <div x-data>
        ...
        <x-bo.card title="Classificazione" bodyClass="p-3">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
        ...
        <x-bo.card title="Attrezzatura" bodyClass="p-3">
            <div class="row">
        ...
        <x-bo.card title="Muscoli coinvolti" bodyClass="p-3">
