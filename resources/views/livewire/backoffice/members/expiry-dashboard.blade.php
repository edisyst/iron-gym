    ...
    <x-bo.filters>
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Nome, cognome o email..." class="form-control form-control-sm filter-w-lg">
            </div>
            <div class="col-md-4">
                <label class="small">Certificati in scadenza entro</label>
                <select wire:model.live="certDays" class="form-control form-control-sm filter-w-sm">
            ...
            <div class="col-md-4">
                ...
                <select wire:model.live="subDays" class="form-control form-control-sm filter-w-sm">
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <table class="table table-sm table-striped table-hover mb-0">
                ...
                <tbody>
                    @forelse ($expiringCerts as $member)
                        @php
                    ...
                    @empty
                        <x-bo.empty :colspan="6">Nessun certificato in scadenza nel periodo selezionato.</x-bo.empty>
                    @endforelse
                </tbody>
            </table>
            </div>
        ...
        <div class="card-body p-0">
            ...
            <table class="table table-sm table-striped table-hover mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <x-bo.empty :colspan="6">Nessun abbonamento in scadenza nel periodo selezionato.</x-bo.empty>
                    @endforelse
                </tbody>
            </table>
            </div>
